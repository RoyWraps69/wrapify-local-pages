      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-white/10 pt-8 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <h5 className="font-medium mb-3 text-sm">Resources</h5>
              <ul className="space-y-2">
                <li>
                  <Link to="/vinyl-wrap-care-guide" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Vinyl Wrap Care Guide
                  </Link>
                </li>
                <li>
                  <Link to="/ceramic-coating-faq" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Ceramic Coating FAQ
                  </Link>
                </li>
                <li>
                  <Link to="/design-template-library" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
            ...
            <div>
              <h5 className="font-medium mb-3 text-sm">Industries</h5>
              <ul className="space-y-2">
                <li>
                  <Link to="/industries/construction" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Construction
                  </Link>
                </li>
                <li>
                  <Link to="/industries/food-beverage" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Food & Beverage
                  </Link>
                </li>
                <li>
                  <Link to="/industries/real-estate" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Real Estate
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/warranty-information" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Warranty Information
                  </Link>
                </li>
                <li>
                  <Link to="/wrap-installation-process" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Installation Process
                  </Link>
                </li>
                <li>
                  <Link to="/payment-options" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Payment Options
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h5 className="font-medium mb-3 text-sm">About Us</h5>
              <ul className="space-y-2">
                <li>
                  <Link to="/our-team" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Our Team
                  </Link>
                </li>
                <li>
                  <Link to="/careers" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Careers
                  </Link>
                </li>
                <li>
                  <Link to="/testimonials" className="text-wrap-light/70 text-sm hover:text-wrap-red transition-colors">
                    Testimonials
                  </Link>
                </li>
              </ul>
