      ...
      <div className="container mx-auto">
        ...
        <div className="glass-card p-8 md:p-12 text-center max-w-5xl mx-auto">
          <span className="inline-block px-4 py-1 bg-wrap-red/10 text-wrap-red rounded-full text-sm font-medium mb-4">
            <MapPin className="inline-block mr-1 h-4 w-4" /> WRAPPING THE WORLD - Car Wraps in {townName}
          </span>
          ...
          <p className="text-wrap-light/90 text-lg mb-8 max-w-3xl mx-auto">
            Contact <span className="font-bold">WRAPPING THE WORLD</span> today for a free talk and quote. 
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white/10 p-6 rounded-lg text-left hover:bg-white/15 transition-all">
              <h3 className="text-xl font-semibold text-white mb-4">Why Choose <span className="font-bold">WRAPPING THE WORLD</span> in {townName}?</h3>
            ...
            <div className="bg-white/10 p-6 rounded-lg text-left hover:bg-white/15 transition-all">
              <h3 className="text-xl font-semibold text-white mb-4">Contact <span className="font-bold">WRAPPING THE WORLD</span> {townName}</h3>
