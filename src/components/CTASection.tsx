      ...
      <div className="container mx-auto">
        <div className="glass-card p-8 md:p-12 text-center max-w-5xl mx-auto">
          ...
          <p className="text-wrap-light/90 text-lg mb-8 max-w-3xl mx-auto">
            ...
            Our team of experts in {townName} is ready to help you create the perfect wrap for your vehicle.
          </p>
          ...
          <p className="text-wrap-light/70 text-sm">
            Serving {townName} and surrounding areas with premium vehicle wrap services.
          </p>
        </div>
      </div>
    </section>
