        ...
        >
          ...
          >
            ...
            <motion.div variants={itemVariants} className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-serif font-semibold mb-3 text-wrap-blue">Installer Network</h3>
              <p className="text-wrap-grey mb-4">
                Access our nationwide network of certified installers to ensure professional application of your vehicle wrap for optimal results.
              </p>
            </motion.div>
