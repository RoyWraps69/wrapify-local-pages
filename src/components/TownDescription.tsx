      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <h2 className="text-3xl font-serif font-semibold text-wrap-blue mb-6">
            <span className="font-bold">WRAPPING THE WORLD</span> - Top Car Wraps & Coatings in <a href={governmentUrl} target="_blank" rel="noopener noreferrer" className="text-wrap-blue hover:text-wrap-red underline">{townName}</a>, {state}
          </h2>
          
          <p className="mb-6">
            Welcome to <span className="font-bold">WRAPPING THE WORLD</span>, your best choice for <Link to="/services/commercial-fleet-wraps" className="text-wrap-blue hover:text-wrap-red font-semibold">car wraps</Link>, 
          ...
          <p className="mb-6">
            {description} <span className="font-bold">WRAPPING THE WORLD</span> offers total <strong>car makeover solutions</strong> including 
          ...
          <div className="my-8 p-6 bg-white rounded-lg shadow-soft border border-wrap-blue/10">
            <div className="flex justify-between items-center mb-3">
              <h3 className="text-xl font-serif font-semibold text-wrap-blue flex items-center">
                <Car className="mr-2 text-wrap-red" size={20} />
                <span className="font-bold">WRAPPING THE WORLD</span> Services in <a href={governmentUrl} target="_blank" rel="noopener noreferrer" className="text-wrap-blue hover:text-wrap-red underline ml-1">{townName}</a>:
              </h3>
              <img 
                src="/lovable-uploads/497ecda8-3e8f-4eb8-9d97-bdd37187e766.png" 
                alt="WRAPPING THE WORLD" 
            ...
            <div className="mt-4 text-center">
              <Link to="/services" className="inline-flex items-center text-wrap-blue hover:text-wrap-red font-medium">
                See all <span className="font-bold">WRAPPING THE WORLD</span> services in {townName}
          ...
          <div className="mb-8 flex flex-col sm:flex-row gap-6">
            <div className="flex-1 bg-wrap-blue/5 p-5 rounded-lg">
              ...
              <p className="text-wrap-grey text-sm leading-relaxed">
                ...
                ads. From building companies to service pros to delivery fleets, <span className="font-bold">WRAPPING THE WORLD</span>'s custom
            ...
            <div className="flex-1 bg-wrap-blue/5 p-5 rounded-lg">
              ...
              <p className="text-wrap-grey text-sm leading-relaxed">
                For your own car, <span className="font-bold">WRAPPING THE WORLD</span>'s <strong>ceramic coating</strong> and <strong>paint protection film</strong> give 
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-wrap-grey text-sm mt-2">No need to buy • Fast answer • <span className="font-bold">WRAPPING THE WORLD</span> {townName} service ready</p>
          </div>
        </div>
      </div>
    </section>
